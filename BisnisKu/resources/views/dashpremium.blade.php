                ...
                >
                    ...
                    <ul class="menu-inner py-1">
                        ...
                        <li class="menu-item active open">
                            ...
                            >
                                <i
                                    class="menu-icon tf-icons bx bx-home-smile"
                                ></i>
                                <div
                                    class="text-truncate"
                        ...
                        <li class="menu-item">
                            ...
                            >
                                <i
                                    class="menu-icon tf-icons bx bx-envelope"
                                ></i>
                        ...
                        <li class="menu-item">
                            ...
                            >
                                <i
                                    class="menu-icon tf-icons bx bx-calendar"
                                ></i>
                        ...
                        <li class="menu-item">
                            ...
                            >
                                <i
                                    class="menu-icon tf-icons bx bx-dock-top"
                                ></i>
                                <div
                                    class="text-truncate"
                        ...
                        <li class="menu-item">
                            ...
                            >
                                <i
                                    class="menu-icon tf-icons bx bx-cube-alt"
                                ></i>
                        ...
                        <li class="menu-item">
                            ...
                            >
                                <i
                                    class="menu-icon tf-icons bx bx-list-check"
                                ></i>
                                <div
                                    class="text-truncate"
                        ...
                        <div class="container-xxl flex-grow-1 container-p-y">
                            <div class="row">
                                <div class="col-xxl-8 mb-6 order-0">
                                    <div class="card">
                                        <div
                                            class="d-flex align-items-start row"
                                        >
                                            <div class="col-sm-7">
                                                <div class="card-body">
                                                    <h5
                                                    ...
                                                    <p class="mb-6">
                                                        You have done 72% more
                                                        sales today.<br />Check
                                            ...
                                            >
                                                <div
                                                    class="card-body pb-0 px-0 px-md-6"
                                                >
                                                    <img
                                                    src=imgs/man-with-laptop.png
                                                    height="175"
                                                    class="scaleX-n1-rtl"
                                                    alt="View Badge User">
                                                </div>
                                ...
                                <div class="col-lg-4 col-md-4 order-1">
                                    <div class="row">
                                        <div
                                            class="col-lg-6 col-md-12 col-6 mb-6"
                                        >
                                ...
                                >
                                    <div class="card">
                                        <div class="row row-bordered g-0">
                                            ...
                                            <div
                                                class="col-lg-4 d-flex align-items-center"
                                            >
                                                <div class="card-body px-xl-9">
                                                    ...
                                                    <div
                                                        class="text-center fw-medium my-6"
                                                    >
                                                        62% Company Growth
                                                    </div>
                                                        ...
                                                        <div class="d-flex">
                                                            ...
                                                            >
                                                                <span
                                                                    ...
                                                                    ><i
                                                                        class="bx bx-wallet bx-lg text-info"
                                                                    ></i
                                                                ></span>
                                                            </div>
                                                            <div
                            ...
                            <div class="row">
                                <!-- Order Statistics -->
                                <div
                                    class="col-md-6 col-lg-4 col-xl-4 order-0 mb-6"
                                >
                                    <div class="card h-100">
                                        <div
                                        ...
                                        >
                                            ...
                                            <div class="dropdown">
                                                ...
                                                >
                                                    <i
                                                        class="bx bx-dots-vertical-rounded bx-lg"
                                                    ></i>
                                                </button>
                                                <div
                                                    class="dropdown-menu dropdown-menu-end"
